...
@router.get("/game/{room_id}/history", summary="获取游戏行动历史")
async def get_game_history(
    ...
    for entry in history:
        player_name = game.players[entry["player_idx"]]["name"] if "player_idx" in entry else None
        ...
        history_with_names.append(history_entry)
    ...
    return {
        ...
        "data": {
            "room_id": room_id,
            "current_round": round_names[game.betting_round] if game.betting_round < len(round_names) else "Showdown",
